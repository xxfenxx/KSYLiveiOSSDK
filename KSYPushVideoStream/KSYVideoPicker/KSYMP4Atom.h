...
@class KSYMP4Descriptor;
@class KSYBytesData;

@interface KSYMP4Atom : NSObject
 ...
 */
- (KSYMP4Atom *)lookup:(long)type number:(long)number;
...
@property (atomic, retain) KSYMP4Descriptor *esdDescriptor;
